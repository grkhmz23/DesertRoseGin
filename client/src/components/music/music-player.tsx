...
export function MusicPlayer() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-4 right-4 z-[80] flex items-center gap-2 px-3 py-2 bg-[#2B1810]/80 backdrop-blur-sm border border-[#F5EFE6]/20 text-[#F5EFE6]/70 hover:text-[#CD7E31] hover:border-[#CD7E31]/50 transition-all duration-300"
