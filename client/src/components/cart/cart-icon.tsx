...
export function CartIcon() {
  ...
  return (
    <button
      ...
      className="fixed top-20 right-6 md:top-20 md:right-8 z-[90] flex h-10 w-10 items-center justify-center text-[#CD7E31]/70 hover:text-[#CD7E31] transition-all duration-300"
    >
