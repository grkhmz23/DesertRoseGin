...
export function DesertRoseGalleryLanding() {
  ...
  const cocktailBookletImage = cocktailBookletImg;
  const classicData = {
    id: 'classic',
    ...
    options: [
      ...
      { size: t('ui.product.options.gift500Classic'), price: `54,90${vatSuffix}`, image: giftBox2x500Classic, note: giftNote, shopifyLookupSize: "500ml Gift Box" },
      { size: t('ui.product.options.duo500GiftClassic'), price: `109,80${vatSuffix}`, image: classicGiftBox, note: duoGiftNote, shopifyLookupSize: "2 x 500ml Gift Box" },
      { size: t('ui.product.options.box6x500Classic'), price: `292,80${vatSuffix}`, image: sixBottleBox, note: boxNote, shopifyLookupSize: "Box of 6 x 50cl", isBox: true },
      { size: t('ui.product.options.doubleBox6x500Classic'), price: `554${vatSuffix}`, image: doubleBoxImage, note: doubleBoxNote, shopifyLookupSize: "2 x Box of 6 x 50cl", isBox: true },
  ...
  const limitedData = {
    ...
    options: [
      ...
      { size: t('ui.product.options.gift500Limited'), price: `62,35${vatSuffix}`, image: giftBox2x500Limited, note: giftNote, shopifyLookupSize: "500ml Gift Box" },
      { size: t('ui.product.options.duo500Limited'), price: `101,35${vatSuffix}`, image: bottleLimited, shopifyLookupSize: "2 x 500ml Bottle" },
      { size: t('ui.product.options.duo500GiftLimited'), price: `118,45${vatSuffix}`, image: limitedGiftBox, note: duoGiftNote, shopifyLookupSize: "2 x 500ml Gift Box" },
